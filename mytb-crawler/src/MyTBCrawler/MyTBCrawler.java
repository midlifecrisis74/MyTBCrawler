...
public class MyTBCrawler {
  ...
  public static void main(String[] args) {
    ...
    String wp_username = new String("dein-benutzername");
    
    // Euer Wordpress Passwort :-)
    String wp_password = new String("dein-passwort");
    
    // URL zu Eurem Wordpress-Blog - das xmlrpc.php am Ende ist wichtig!
    String wp_url = new String("https://DEINE-WORDPRESS-URL/xmlrpc.php");
    
    // myTagebuch Autoren id
    Integer mytb_id = new Integer(47110815);
    ...
    try {
      for(int i = 0; i <= mytb_entries/25; i++) {
        ...
        for (Element tb_eintrag : tb_eintraege) {
          ...
          System.out.println(datum.text() + " - " + linkText);
          //System.out.println("===============================================================================================");
